                                    ...
                                    <div class="jsgrid-grid-header jsgrid-header-scrollbar">
                                        <table class="jsgrid-table table table-striped table-hover">
                                            <tr class="jsgrid-header-row">
                                                <th class="jsgrid-header-cell jsgrid-header-sortable" style="width: 127px;">Account Type Name</th>
                                        ...
                                        <table class="jsgrid-table table table-striped table-hover">
                                            <tbody>
                                                <asp:Repeater ID="Repeater1" runat="server"> 
                                                    <ItemTemplate>
                                            <tr class="jsgrid-row">
                                            <td class="jsgrid-cell" style="width: 163px;"><%#Eval("Acc_Type_Name") %></td>
                                                <td class="jsgrid-cell jsgrid-align-center" style="width: 200px;"><%#Eval("Acc_Type_Description") %></td>
