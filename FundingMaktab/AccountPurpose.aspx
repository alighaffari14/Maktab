<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/Main.Master" CodeBehind="AccountPurpose.aspx.cs" Inherits="FundingMaktab.AccountPurpose" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="body" runat="server">
    <div class="row">
        <div class="col-12">
                   <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">List of All Account's Purpose</h4>
                                <div id="basicgrid" class="jsgrid" style="position: relative; height: 500px; width: 100%;">
                                    <div class="jsgrid-grid-header jsgrid-header-scrollbar">
                                        <table class="jsgrid-table table table-striped table-hover">
                                            <tr class="jsgrid-header-row">
                                                <th class="jsgrid-header-cell jsgrid-header-sortable" style="width: 105px;">Account Name</th>
                                                <th class="jsgrid-header-cell jsgrid-align-right jsgrid-header-sortable" style="width: 120px;">Purpose</th>
                                        ...
                                        <table class="jsgrid-table table table-striped table-hover">
                                            <tbody>
                                                <asp:Repeater ID="Repeater1" runat="server"> 
                                                    <ItemTemplate>
                                            <tr class="jsgrid-row">
                                            <td class="jsgrid-cell" style="width: 183px;"><%#Eval("Acc_Name") %></td>
                                                <td class="jsgrid-cell jsgrid-align-center" style="width: 155px;"><%#Eval("Purpose_Name") %></td>
