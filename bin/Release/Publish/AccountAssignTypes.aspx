<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/Main.Master" CodeBehind="AccountAssignTypes.aspx.cs" Inherits="FundingMaktab.AccountAssignTypes" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="body" runat="server">
    <div class="row">
        <div class="col-12">
                   <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">List of Accounts with their Types</h4>
                                <div id="basicgrid" class="jsgrid" style="position: relative; height: 500px; width: 100%;">
                                    <div class="jsgrid-grid-header jsgrid-header-scrollbar">
                                        <table class="jsgrid-table table table-striped table-hover">
                                            <tr class="jsgrid-header-row">
                                                <th class="jsgrid-header-cell jsgrid-header-sortable" style="width: 27px;">Account Name</th>
                                                <th class="jsgrid-header-cell jsgrid-align-left jsgrid-header-sortable" style="width: 40px;">Type</th>
                                        ...
                                        <table class="jsgrid-table table table-striped table-hover">
                                            <tbody>
                                                <asp:Repeater ID="Repeater1" runat="server"> 
                                                    <ItemTemplate>
                                            <tr class="jsgrid-row">
                                            <td class="jsgrid-cell" style="width: 110px;"><%#Eval("Acc_Name") %></td>
                                                <td class="jsgrid-cell jsgrid-align-center" style="width: 85px;"><%#Eval("Acc_Type_Name") %></td>
