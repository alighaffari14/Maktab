                                    ...
                                    <div class="jsgrid-grid-header jsgrid-header-scrollbar">
                                        <table class="jsgrid-table table table-striped table-hover">
                                            <tr class="jsgrid-header-row">
                                                <th class="jsgrid-header-cell jsgrid-header-sortable" style="width: 127px;">Account Name</th>
                                                <th class="jsgrid-header-cell jsgrid-align-right jsgrid-header-sortable" style="width: 70px;">Initial Amount</th>
                                                <th class="jsgrid-header-cell jsgrid-align-center jsgrid-header-sortable" style="width: 200px;">Description</th>
                                        ...
                                        <table class="jsgrid-table table table-striped table-hover">
                                            <tbody>
                                                <asp:Repeater ID="Repeater1" runat="server"> 
                                                    <ItemTemplate>
                                            <tr class="jsgrid-row">
                                            <td class="jsgrid-cell" style="width: 163px;"><%#Eval("Acc_Name") %></td>
                                                <td class="jsgrid-cell jsgrid-align-center" style="width: 85px;"><%#Eval("Acc_InitialAmount") %></td>
                                                <td class="jsgrid-cell jsgrid-align-center" style="width: 200px;"><%#Eval("Acc_Desc") %></td>
