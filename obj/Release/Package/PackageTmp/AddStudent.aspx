<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/Main.Master" CodeBehind="AddStudent.aspx.cs" Inherits="FundingMaktab.AddStudent" %>
                            ...
                            <div class="card-body">
                                ...
                                <form id="form1" class="form" runat="server">
                                    <div class="form-group mt-5 row">
                                        <label for="example-text-input" class="control-label">Student Name</label>
                                        <div class="col-10">
                                     ...
                                     <div class="form-group row">
                                        <label for="example-month-input2" class="control-label">Class</label>
                                        <div class="col-10">
                                    ...
                                    <div class="form-group row">
                                        <label for="example-month-input2" class="control-label">Center</label>
                                        <div class="col-10">
                                            <asp:DropDownList ID="DropDownList2" CssClass="custom-select col-12" runat="server"></asp:DropDownList>
                                        </div>
                                    </div>
                                  <%--  <div class="form-group row">
